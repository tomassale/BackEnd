const { FileSystemContainer } = require("../../containers/FSContainer.js");
const productFactory = require("../product/daoFactoryProduct.js");

class CartFileSystemDAO extends FileSystemContainer {
  constructor(fileName) {
    super(fileName + ".txt");
    this.productFileSystemDAO = productFactory(process.env.STORE);
  }
